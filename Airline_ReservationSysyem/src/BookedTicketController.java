...
public class BookedTicketController implements Initializable {
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        // FirstNameColumn.setCellValueFactory(new PropertyValueFactory<BookedTicket,
        // String>("fname"));
        // LastNameColumn.setCellValueFactory(new PropertyValueFactory<BookedTicket,
        // String>("lname"));
        // mobileNoColumn.setCellValueFactory(new PropertyValueFactory<BookedTicket,
        // String>("phone"));
        // bookDateColumn.setCellValueFactory(new PropertyValueFactory<BookedTicket,
        // String>("date"));
        // emalIdColumn.setCellValueFactory(new PropertyValueFactory<BookedTicket,
        // String>("email"));
        // noOfPersonColumn.setCellValueFactory(new PropertyValueFactory<BookedTicket,
        // Integer>("no_person"));
        // ticketPriceColumn.setCellValueFactory(new PropertyValueFactory<BookedTicket,
        // Integer>("ticket_price"));
        // finalPriceColumn.setCellValueFactory(new PropertyValueFactory<BookedTicket,
        // Integer>("total_price"));
